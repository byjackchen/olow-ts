...
export const configSchema = z.object({
  ...
  engine: z.object({
    ...
    click_valid_timelapse_seconds: z.number().default(1800),
    user_context_buffer_seconds: z.number().default(259200),
    greeting_silent_seconds: z.number().default(3600),
    recent_queries_cutoff_seconds: z.number().default(900),
    rolling_requests_threshold: z.number().default(60),
    ...
    logging: z.object({
      ...
      backup_count: z.number().default(5),
  ...
  mcp_client: z.object({
    enabled: z.boolean().default(false),
    servers: z.array(z.record(z.unknown())).default([]),
  }).default({}),
  ...
  error_handling: z.object({
    ...
    retry_delay_ms: z.number().default(500),
  }),

  broker: z.object({
    expiretime_offset_seconds: z.number().default(120),
  }),
  ...
  wecom_bot: z.object({
    ...
    text_msg_bytes_limit: z.number().default(4750),
    richtext_msg_bytes_limit: z.number().default(4000),
  }),
  ...
  statistics: z.object({
    time_interval: z.number().default(900),
    prob_new_topic: z.number().default(0),
  }),
});
