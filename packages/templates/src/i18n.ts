...
export const I18n = {
  ...
  AI_IDLE_ASR: i18n({ en: 'Transcribing voice message...', cn: '正在转写语音消息...' }),
  AI_ASR_RESULT: i18n({ en: 'Voice transcription: ', cn: '语音转写：' }),
  AI_IDLE_OCR: i18n({ en: 'Analyzing image content...', cn: '正在分析图片内容...' }),
  AI_OCR_RESULT: i18n({ en: 'Image analysis: ', cn: '图片分析：' }),
  AI_REACT_RESPONSE_RECOMMENDATION: i18n({ en: '📋 Related:', cn: '📋 相关：' }),
  FOOTER_HELPFUL: i18n({ en: '👍 Helpful', cn: '👍 有帮助' }),
  FOOTER_HELPLESS: i18n({ en: '👎 Not Helpful', cn: '👎 没帮助' }),
  FOOTER_OR: i18n({ en: ' | ', cn: ' | ' }),
  FOOTER_NEED: i18n({ en: ' Need help? ', cn: ' 需要帮助？' }),
  FOOTER_AGENTSUPPORT: i18n({ en: 'Live Agent', cn: '转人工' }),
  FOOTER_GREETING: i18n({ en: '🏠 Menu', cn: '🏠 菜单' }),
} as const;
